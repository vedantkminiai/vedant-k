...
const Hero = () => {
  ...
  return (
    <section
      id="hero"
      className="min-h-screen flex items-center justify-center relative bg-gradient-to-br from-purple-50 via-white to-indigo-50"
    >
      ...
      <div className="absolute top-1/3 right-20 w-12 h-12 bg-indigo-300 rounded-full opacity-25 animate-pulse"></div>
    </section>
  );
};
